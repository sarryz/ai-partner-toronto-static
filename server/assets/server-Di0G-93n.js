...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C5lH7bLh.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CHR9Cw2J.js"),
    import("./start-DVq25pf0.js"),
...
var ROUTER_BASEPATH = "ai-partner-toronto";
var SERVER_FN_BASE = "/ai-partner-toronto/_serverFn/";
